...
| [S3](S3-postfix-template-engine.md) | Postfix template engine | Done |
| [S4](S4-lsp-adapter-mvp.md) | LSP adapter MVP | Done |
| [S5](S5-prefix-expansions.md) | Prefix expansions + conflict strategy | Done |
| [S6](S6-surround-selection.md) | Surround & selection expansions | Done |
| [S7](S7-multi-language.md) | Multi-language + backend resolution | Done |
| [S8](S8-roslyn-sidecar.md) | Roslyn sidecar + semantic enrichment | Done |
| [S9](S9-command-expansions.md) | Command expansions | Done |
...
| [S12](S12-editor-integrations.md) | Editor integrations (VS Code, Visual Studio) | Not started |
