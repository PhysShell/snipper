...
public class TabstopInserterTests
{
    ...
    public async Task InsertAsync_CreatedSnippetFile_ContainsExpectedXml()
    {
        ...
        // File may already be deleted by the async cleanup; read it from the stub's captured copy.
    ...
    private sealed class PlainTextViewStub : IVsTextView
    {
        ...
        // All other members are unused in the no-expansion-view path.
        ...
        public WORDEXTFLAGS GetSelectionMode() => 0;
        ...
        public int GetWordExtent(int iLine, int iCol, WORDEXTFLAGS dwFlags, TextSpan[] pSpan) => VSConstants.E_NOTIMPL;
        ...
        public int SetSelectionMode(WORDEXTFLAGS iSelMode) => VSConstants.E_NOTIMPL;
